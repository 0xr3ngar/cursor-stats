...
const metadata: Record<GeneratedNames, GeneratedCommandMeta> = {
  'sync': {
      ...
      options: {
        ...
        'push': { type: 'z.boolean.default', required: true, hasDefault: true, default: false, description: 'Commit and push the generated files to the git remote', short: 'p', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3138,"end":3143,"loc":{"start":{"line":86,"column":41,"index":3138},"end":{"line":86,"column":46,"index":3143}},"value":false}}]}, validator: '(val) => true' },
        'show-composer': { type: 'z.boolean.default', required: true, hasDefault: true, default: true, description: 'Show the composer metric (hide with --show-composer false)', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3352,"end":3356,"loc":{"start":{"line":91,"column":52,"index":3352},"end":{"line":91,"column":56,"index":3356}},"value":true}}]}, validator: '(val) => true' },
        'show-tab': { type: 'z.boolean.default', required: true, hasDefault: true, default: true, description: 'Show the tab metric (hide with --show-tab false)', schema: {"type":"zod","method":"default","args":[{"type":"unknown","raw":{"type":"BooleanLiteral","start":3541,"end":3545,"loc":{"start":{"line":95,"column":47,"index":3541},"end":{"line":95,"column":51,"index":3545}},"value":true}}]}, validator: '(val) => true' },
